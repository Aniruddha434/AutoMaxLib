...
export const seoData = {
  ...
  repositoryReadmeGenerator: {
    title: 'Repository README Generator AI - Create Project Documentation',
    description: 'Generate comprehensive repository READMEs with AI. Perfect for documenting your projects with installation guides, usage examples, and professional formatting.',
    keywords: 'repository README generator, project documentation AI, README creator, GitHub repository documentation, AI documentation generator, project README maker',
    structuredData: {
      "@context": "https://schema.org",
      "@type": "SoftwareApplication",
  ...
  autoCommit: {
    ...
    structuredData: {
      ...
      "featureList": [
        "Intelligent auto commit generation",
